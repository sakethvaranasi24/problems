...
- Problem ID: 0619
- Tags: Database
- Problem Link: [https://leetcode.com/problems/biggest-single-number/](https://leetcode.com/problems/biggest-single-number/)
...
| Status | Accepted |
| Language | MySQL |
| Runtime | 408 ms (93.15%) |
| Memory | 0B (100.00%) |
| Submission ID | 2123761002 |
