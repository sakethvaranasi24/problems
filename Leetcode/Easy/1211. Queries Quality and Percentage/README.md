...
- Problem ID: 1211
- Tags: Database
- Problem Link: [https://leetcode.com/problems/queries-quality-and-percentage/](https://leetcode.com/problems/queries-quality-and-percentage/)
...
| Status | Accepted |
| Language | MySQL |
| Runtime | 353 ms (89.50%) |
| Memory | 0B (100.00%) |
| Submission ID | 2123753953 |
