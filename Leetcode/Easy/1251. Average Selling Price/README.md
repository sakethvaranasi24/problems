...
- Problem ID: 1251
- Tags: Database
- Problem Link: [https://leetcode.com/problems/average-selling-price/](https://leetcode.com/problems/average-selling-price/)
...
| Status | Accepted |
| Language | MySQL |
| Runtime | 1230 ms (9.30%) |
| Memory | 0B (100.00%) |
| Submission ID | 2119753272 |
