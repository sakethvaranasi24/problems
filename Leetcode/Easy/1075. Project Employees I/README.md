...
- Problem ID: 1075
- Tags: Database
- Problem Link: [https://leetcode.com/problems/project-employees-i/](https://leetcode.com/problems/project-employees-i/)
...
| Status | Accepted |
| Language | MySQL |
| Runtime | 733 ms (12.01%) |
| Memory | 0B (100.00%) |
| Submission ID | 2119826433 |
